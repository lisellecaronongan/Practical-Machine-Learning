...
With random forest, we reach an accuracy of 99.3% using cross-validation with 5 steps.Out-of sample error rate is 0.7%.  This is already good. But let's see what we can expect with Gradient boosting.
